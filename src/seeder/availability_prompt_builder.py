...
class AvailabilityPromptBuilder:
    ...
    def _build_generation_instructions(
        ...
        return (
            f"Generate a JSON array of exactly {num_days} availability calendar "
            f"day objects, one per day, starting from {start_date}.\n\n"
            "### Date Sequence\n"
            ...
            "### Opening Hours\n"
            "12. For OPENING_HOURS products: include 1-2 openingHours entries "
            "with realistic from/to times (e.g. '09:00' to '17:00').\n"
            "13. For START_TIME products: openingHours MUST be an empty array [].\n\n"
            "### Extended Fields\n"
            "14. Optionally include statusMessage for some days "
            "(e.g. 'Available', 'Sold Out', 'Closed for maintenance').\n"
            "15. Do NOT include weight-related fields unless the product "
            "is clearly weight-based (e.g. skydiving, bungee).\n"
            "16. maxUnits: include occasionally, realistic values (4-10).\n\n"
            "### Realism\n"
            "17. Consider the product's country and timezone for seasonal "
            "patterns. Outdoor activities should have more CLOSED days in "
            "winter months. Night activities should have late opening hours.\n"
            "18. Weekends may have different patterns than weekdays.\n"
            "19. Do NOT generate identical days — vary vacancies and status.\n\n"
            "### Output Format\n"
