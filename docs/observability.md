...
| `otas_seeder_validation_failures_total` | Counter | Entities rejected by leakage check |
...
| `otas_server_availability_slots_count` | Gauge | Current slot count in state |
...
| `otas_product_availability_slots_count` | Gauge | Slots per product-option |
| `otas_product_availability_days_count` | Gauge | Available days per product-option |
| `otas_product_requests_total` | Counter | Requests per product |
| `otas_product_availability_queries_total` | Counter | Availability queries per product-option |
